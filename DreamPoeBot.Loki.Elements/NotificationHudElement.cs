		...
		public LokiPoe.InGameState.NotificationType NotificationTypeEnum
		{
			get
			{
				if (!_notificationTypeEnum.HasValue)
				{
					...
					{
						if (!Type.Equals(LokiPoe.InGameState.NotificationHud.LocalCache.TradeRequestNotification, StringComparison.OrdinalIgnoreCase))
						{
							if (!Type.Equals(LokiPoe.InGameState.NotificationHud.LocalCache.PartyInviteNotification, StringComparison.OrdinalIgnoreCase))
							{
