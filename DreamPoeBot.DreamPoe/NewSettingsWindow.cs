...
public class NewSettingsWindow : MetroWindow, IComponentConnector
{
		...
		default:
		{
			...
			if (num <= 1362938492)
			{
				if (num > 734743310)
				{
					if (num > 889009852)
					{
						...
						else if (!(name == "AutoPassives"))
						{
							goto IL_035f;
						}
					}
					else if (num != 751401973)
					{
						if (num == 786658466)
						{
							if (!(name == "Monoliths"))
				...
				if (num > 539747502)
				{
					...
					if (name == "ObjectExplorer")
					{
						goto IL_0310;
					}
				}
				else if (num != 287647614)
				{
					if (num != 431371766)
					{
						if (num == 539747502 && !(name != "DumpTab"))
						{
							goto IL_0310;
						}
					}
					else if (!(name != "QuestBot"))
					{
						goto IL_0365;
					}
				}
			...
			else if (num > 3056377330u)
			{
				if (num > 4165132789u)
				{
					...
					{
						if (name == "PythonExample")
						{
							goto IL_0310;
						}
					}
					else if (num == 4263613000u && !(name != "AreaVisualizer"))
					{
						goto IL_0310;
					}
				}
			...
			else if (num <= 2102247843)
			{
				...
				else if (num != 1671601186)
				{
					if (num == 2102247843 && !(name != "Overlay"))
					{
						goto IL_0310;
					}
				}
				else if (!(name != "ExternalCommunication"))
				{
					goto IL_0310;
				}
			}
	...
	internal TreeViewItem method_15(params string[] string_0)
	{
		...
		{
			Dictionary<string, TreeViewItem> dictionary = ((treeViewItem != null) ? (treeViewItem.Tag as TreeViewItemTag).Mapping : (NewSettingsTreeView.Tag as TreeViewItemTag).Mapping);
