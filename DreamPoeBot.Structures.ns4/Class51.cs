...
internal class Class51 : Class50, Interface5, Interface6
{
	...
	public uint imethod_7(uint[] uint_26)
	{
		...
		if (!bool_1)
		{
			num8 = (uint)(byte_0[num4] ^ (byte_0[num4 + 1] << 8));
		}
		else
		{
			uint num9 = Class49.uint_0[byte_0[num4]] ^ byte_0[num4 + 1];
			num6 = num9 & 0x3FFu;
			uint num10 = num9 ^ (uint)(byte_0[num4 + 2] << 8);
			num7 = num10 & 0xFFFFu;
			num8 = (num10 ^ (Class49.uint_0[byte_0[num4 + 3]] << 5)) & uint_19;
		}
		uint num11 = uint_18[uint_23 + num8];
		if (bool_1)
		{
