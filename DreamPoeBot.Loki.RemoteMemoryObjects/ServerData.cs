...
public class ServerData : RemoteMemoryObject
{
	...
	public IEnumerable<ushort> SkillBarIds
	{
		get
		{
			...
			SkillbarStruct ids2 = default(SkillbarStruct);
			while (true)
			{
				...
				{
				default:
					switch ((num2 = (num2 * 2793229945u) ^ 0x7040AC5Bu ^ 0x65A6BD34u) % 37u)
					{
					default:
						yield break;
					case 19u:
...
not to run in case of an exception or early 'break;' out of a loop consuming this iterable.*/;
					...
					case 6u:
						try
						{
							goto IL_0204;
							IL_0204:
							/*Error near IL_0205: Unexpected return in MoveNext()*/;
						}
						finally
						{
...
not to run in case of an exception or early 'break;' out of a loop consuming this iterable.*/;
				...
				case 13:
					yield break;
					IL_0294:
					yield return ids2.ushort_11;
					continue;
					IL_0272:
					yield return ids2.ushort_10;
					continue;
					IL_0250:
					yield return ids2.ushort_9;
					continue;
					IL_022e:
					yield return ids2.ushort_8;
					/*Error: Unable to find new state assignment for yield return*/;
					IL_0206:
					yield return ids2.ushort_7;
					continue;
					IL_01e5:
					yield return ids2.ushort_6;
					/*Error: Unable to find new state assignment for yield return*/;
					IL_01c4:
					yield return ids2.ushort_5;
					/*Error: Unable to find new state assignment for yield return*/;
					IL_01aa:
					yield return ids2.ushort_4;
					/*Error: Unable to find new state assignment for yield return*/;
					IL_0182:
					yield return ids2.ushort_3;
					/*Error: Unable to find new state assignment for yield return*/;
					IL_0168:
					yield return ids2.ushort_2;
					continue;
					IL_0140:
					yield return ids2.ushort_1;
					continue;
					IL_010e:
					ids2 = serverData.StructServerData_0.SkillbarIds;
					yield return ids2.ushort_0;
					/*Error: Unable to find new state assignment for yield return*/;
					end_IL_00ca:
					break;
				}
