	...
	public bool Equals(NativeStringWCustom other)
	{
		...
		if (Size == other.Size)
		{
			if (8 > ReservedSize)
			{
				...
				string text = Encoding.Unicode.GetString(bytes3).Substring(0, (int)other.Size);
				...
				string value = Encoding.Unicode.GetString(bytes6).Substring(0, (int)other.Size);
				return text.Equals(value);
			}
			string text2 = GameController.Instance.Memory.ReadStringU(Buf.Address);
			string value2 = GameController.Instance.Memory.ReadStringU(other.Buf.Address);
